...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2022 a las 23:16:44
...
INSERT INTO `peliculas` (`peli_id`, `peli_nombre`, `peli_genero`, `peli_fecha_estreno`, `peli_restricciones`, `peli_dire_id`) VALUES
(1, 'Spiderman: No way home', 'ciencia ficción', '2021-12-15', 'PG-13', 1),
(2, 'Dr. Strange: En el multiverso de la locura', 'acción', '2022-05-05', 'PG-16', 2),
(3, 'Matrix', 'ciencia ficcion', '1999-12-24', 'PG-13', 3),
(4, 'Avenger', 'accion', '2012-05-14', 'PG-13', NULL),
(5, 'Interestellar', 'Drama', '2014-10-08', 'PG-18', 4),
(6, 'El resplandor', 'terror', '1980-10-09', 'PG-18', 5),
(7, 'Titanic', 'Drama romantico', '1997-07-07', 'PG', 6),
(8, 'El codigo enigma', 'bélica', '2017-08-19', 'PG-16', NULL);
