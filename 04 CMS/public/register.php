                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Confirmar contraseña" name="user_pass_confirmar">
                                    </div>
                                </div>
                                <input type="submit" value="Registrar" class="btn btn-primary btn-user btn-block" name="registrar">
                                <hr>
                            </form>
                            <div class="text-center">
